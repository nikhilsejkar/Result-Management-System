...
<center><img src="hdc.png" width="150" height="150">
  ...
  <table>
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td colspan="3"> <% out.println ((sum)/5); %> </td>
      </tr>
  </table>
    <hr class="new1">
  <center><h6>Institution doesn't own for the errors or omissions, if any, in this statement.</h6></center>
  <hr class="new1">
<center><h6>Web application:: 2022</h6></center> 
  <hr class="new1">
</body>
